...
class build_main_window(Adw.Application):
    ...
    def main_window_activation (self, app):
        ...
        main_window_builder.set_translation_domain('davinci-toolbox')
    ...
    def info_window_1_activation (self, widget):
        ...
        # COMUNICO ALLA FUNZIONE BUILDER QUALE DIZIONARIO USARE PER TRADURRE L'INTERFACCIA
        # TELLING THE BUILDER FUNCTION THE DICTIONARY NAME TO USE FOR THE INTERFACE TRANSLATION
        info_1_window_builder.set_translation_domain('davinci-toolbox')
    ...
    def info_window_2_activation (self, widget):
        ...
        # COMUNICO ALLA FUNZIONE BUILDER QUALE DIZIONARIO USARE PER TRADURRE L'INTERFACCIA
        # TELLING THE BUILDER FUNCTION THE DICTIONARY NAME TO USE FOR THE INTERFACE TRANSLATION
        info_2_window_builder.set_translation_domain('davinci-toolbox')
    ...
    def info_window_3_activation (self, widget):
        ...
        # COMUNICO ALLA FUNZIONE BUILDER QUALE DIZIONARIO USARE PER TRADURRE L'INTERFACCIA
        # TELLING THE BUILDER FUNCTION THE DICTIONARY NAME TO USE FOR THE INTERFACE TRANSLATION
        info_3_window_builder.set_translation_domain('davinci-toolbox')
    ...
    def info_window_4_activation (self, widget):
        ...
        # COMUNICO ALLA FUNZIONE BUILDER QUALE DIZIONARIO USARE PER TRADURRE L'INTERFACCIA
        # TELLING THE BUILDER FUNCTION THE DICTIONARY NAME TO USE FOR THE INTERFACE TRANSLATION
        info_4_window_builder.set_translation_domain('davinci-toolbox')
    ...
    def check_splash_screen(self):
        ...
        with open(f"{settings_path}/davinci_toolbox_settings", 'r', encoding='utf-8') as file :
    ...
    def show_splash_screen (self):
        ...
        # COMUNICO ALLA FUNZIONE BUILDER QUALE DIZIONARIO USARE PER TRADURRE L'INTERFACCIA
        # TELLING THE BUILDER FUNCTION THE DICTIONARY NAME TO USE FOR THE INTERFACE TRANSLATION
        welcome_messagge_window_builder.set_translation_domain('davinci-toolbox')
        ...
        # CARICO IL FILE DELL'ICONA
        # LOADING THE ICON FILE
        self.welcome_messagge_icon.set_from_file(f"{icon_path}/davinci-toolbox-icon.svg")

        # CARICO IL TESTO DEL TITOLO
        # LOADING TITLE TEXT
        self.welcome_messagge_title_text.set_text(_('''You have successfully\ninstalled DaVinci Toolbox !'''))

        # CARICO IL TESTO DEL SOTTOTITOLO
        # LOADING THE SUBTITLE TEXT
        self.welcome_messagge_sub_title_text.set_text(_('''Thank you for trusting us and installing DaVinci Toolbox. We hope that\nthis app will make the installation of DaVinci Resolve easier for you.'''))
        ...
        paragraph_3 = '''If you find this app useful and want to improve it please\nconsider to help us <a href="https://github.com/H3rz3n/davinci-toolbox">developing</a> this app or <a href="https://www.example.com">making a donation</a>  to the project.'''
    ...
    def change_spash_screen_status(self, widget, status):
        ...
        with open(f"{settings_path}/davinci_toolbox_settings", 'w', encoding='utf-8') as file :
...
def main():
    ...
    app_gui = build_main_window(application_id="com.davinci.toolbox.app")
