...
class build_function_3 ():
    ...
    def __init__(self, parent):
        ...
        function_3_window_builder.set_translation_domain('davinci-toolbox')
    ...
    def post_installation (self) :
        ...
        function_3_log = subprocess.Popen("pkexec python /usr/lib/python*/site-packages/davinci_toolbox/functions/function_3.py",shell=True,  stdout=subprocess.PIPE, stderr=subprocess.STDOUT, text=True)
