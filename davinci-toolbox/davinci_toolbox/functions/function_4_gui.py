...
class build_function_4 ():
    ...
    def __init__(self, parent):
        ...
        function_4_window_builder.set_translation_domain('davinci-toolbox')
    ...
    def install_gpu_driver (self) :
        ...
        function_4_log = subprocess.Popen("pkexec python /usr/lib/python*/site-packages/davinci_toolbox/functions/function_4.py",shell=True,  stdout=subprocess.PIPE, stderr=subprocess.STDOUT, text=True)
    ...
    def show_splash_screen (self):
        ...
        # COMUNICO ALLA FUNZIONE BUILDER QUALE DIZIONARIO USARE PER TRADURRE L'INTERFACCIA
        # TELLING THE BUILDER FUNCTION THE DICTIONARY NAME TO USE FOR THE INTERFACE TRANSLATION
        gpu_warning_window_builder.set_translation_domain('davinci-toolbox')
