...
class build_function_1 ():
    ...
    def __init__(self, parent):
        ...
        function_1_window_builder.set_translation_domain('davinci-toolbox')
        ...
        self.icon = function_1_window_builder.get_object("function_1_icon")

        # OTTENGO L'OGGETTO ED I SUOI CHILD DAL FILE UI
        # OBTAINING THE OBJECT AND HIS CHILD FROM THE UI FILE
        self.title_text = function_1_window_builder.get_object("function_1_title_text")

        # OTTENGO L'OGGETTO ED I SUOI CHILD DAL FILE UI
        # OBTAINING THE OBJECT AND HIS CHILD FROM THE UI FILE
        self.subtitle_scrollable_container = function_1_window_builder.get_object("function_1_subtitle_scrollable_container")

        # OTTENGO L'OGGETTO ED I SUOI CHILD DAL FILE UI
        # OBTAINING THE OBJECT AND HIS CHILD FROM THE UI FILE
        self.sub_title_text = function_1_window_builder.get_object("function_1_sub_title_text")

        # OTTENGO L'OGGETTO ED I SUOI CHILD DAL FILE UI
        # OBTAINING THE OBJECT AND HIS CHILD FROM THE UI FILE
        self.log_scrollable_container = function_1_window_builder.get_object("function_1_log_scrollable_container")

        # OTTENGO L'OGGETTO ED I SUOI CHILD DAL FILE UI
        # OBTAINING THE OBJECT AND HIS CHILD FROM THE UI FILE
        self.log_text_viewer = function_1_window_builder.get_object("function_1_log_text_viewer")

        # OTTENGO L'OGGETTO ED I SUOI CHILD DAL FILE UI
        # OBTAINING THE OBJECT AND HIS CHILD FROM THE UI FILE
        self.button_box = function_1_window_builder.get_object("function_1_button_box")

        # OTTENGO L'OGGETTO ED I SUOI CHILD DAL FILE UI
        # OBTAINING THE OBJECT AND HIS CHILD FROM THE UI FILE
        self.log_button = function_1_window_builder.get_object("function_1_log_button")

        # OTTENGO L'OGGETTO ED I SUOI CHILD DAL FILE UI
        # OBTAINING THE OBJECT AND HIS CHILD FROM THE UI FILE
        self.exit_button = function_1_window_builder.get_object("function_1_exit_button")

        # OTTENGO L'OGGETTO ED I SUOI CHILD DAL FILE UI
        # OBTAINING THE OBJECT AND HIS CHILD FROM THE UI FILE
        self.spinner_box = function_1_window_builder.get_object("function_1_spinner_box")

        # OTTENGO L'OGGETTO ED I SUOI CHILD DAL FILE UI
        # OBTAINING THE OBJECT AND HIS CHILD FROM THE UI FILE
        self.waiting_text = function_1_window_builder.get_object("function_1_waiting_text")

        # OTTENGO L'OGGETTO ED I SUOI CHILD DAL FILE UI
        # OBTAINING THE OBJECT AND HIS CHILD FROM THE UI FILE
        self.spinner = function_1_window_builder.get_object("function_1_spinner")
        ...
        self.exit_button.connect('clicked', lambda button: self.function_1_window.destroy())
    ...
    def install_dependencies (self) :
        ...
        function_1_log = subprocess.Popen("pkexec python /usr/lib/python*/site-packages/davinci_toolbox/functions/function_1.py",shell=True,  stdout=subprocess.PIPE, stderr=subprocess.STDOUT, text=True)
        function_1_log_output, function_1_log_err = function_1_log.communicate()

        # AL COMPLETAMENTO DEL PROCESSO AGGIORNO LA GUI
        # ON PROCESS END UPDATE THE GUI
        GLib.idle_add(self.on_task_complete, function_1_log, function_1_log_output, function_1_log_err )
    ...
    def on_task_complete(self, function_1_log, function_1_log_output, function_1_log_err):
        ...
        self.check_and_load_log_text(function_1_log, function_1_log_output, function_1_log_err)
    ...
    def check_and_load_log_text (self, function_1_log, function_1_log_output, function_1_log_err):
        ...
        if function_1_log.returncode == 1 :
            ...
            log_output = str(function_1_log_output) + str(function_1_log_err)
    ...
    def show_success (self):
        ...
        self.title_text.set_text(_("The dependencies have been correctly installed"))

        # CARICO IL TESTO DEL SOTTOTITOLO IN CASO DI SUCCESSO
        # LOADING THE SUBTITLE TEXT IN CASE OF SUCCESS
        self.sub_title_text.set_text(_("All the dependencies have been correctly installed inside the system. Now you can close this window and correctly start the DaVinci Resolve installer."))
    ...
    def show_error (self):
        ...
        self.title_text.set_text(_("There was an error installing the dependencies"))
