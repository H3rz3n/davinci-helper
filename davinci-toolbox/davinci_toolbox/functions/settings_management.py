...
class build_reset_settings_window ():
    ...
    def __init__(self, parent):
        ...
        reset_settings_window_builder.set_translation_domain('davinci-toolbox')
...
def install_default_settings ():
    ...
    create_folder = subprocess.run(f"mkdir -p '{settings_path}/davinci_toolbox'",shell=True, text=True)

    # COPIO LE IMPOSTAZIONI PREDEFINITE
    # COPYING THE DEFAULT SETTINGS
    copy_default_settings =  subprocess.run(f"cp /usr/share/davinci-toolbox/data/settings/davinci_toolbox_settings {settings_path}/davinci_toolbox/",shell=True, text=True)
...
def check_settings_existence ():
    ...
    flag_settings = pathlib.Path(f'{settings_path}/davinci_toolbox/davinci_toolbox_settings')
...
def restore_settings() :
    ...
    delete_user_settings = subprocess.run(f"rm {settings_path}/davinci_toolbox/davinci_toolbox_settings",shell=True, text=True)
