...
- Japanese (Coming soon)
 ...
 The most simple way to install and keep DaVinci Helper updated  is to add the project COPR repository to your repository list and simply install it with the DNF packet manager.
