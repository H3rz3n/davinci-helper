...
%description
DaVinci Toolbox is the ultime app to help you install and run Davinci Resolve on Fedora Linux.
...
install -Dm644 %{_builddir}/%{name}-%{version}/data/desktop/com.davinci.toolbox.app.desktop %{buildroot}%{_datadir}/applications/com.davinci.toolbox.app.desktop
install -Dm644 %{_builddir}/%{name}-%{version}/data/desktop/davinci-toolbox-icon.svg %{buildroot}%{_datadir}/icons/hicolor/scalable/apps/davinci-toolbox-icon.svg
install -Dm644 %{_builddir}/%{name}-%{version}/data/desktop/com.davinci.toolbox.app.metainfo.xml %{buildroot}%{_datadir}/metainfo/com.davinci.toolbox.app.metainfo.xml

install -Dm644 %{_builddir}/%{name}-%{version}/data/polkit/com.davinci.toolbox.app.policy %{buildroot}/%{_datadir}/polkit-1/actions/com.davinci.toolbox.app.policy
install -Dm644 %{_builddir}/%{name}-%{version}/data/polkit/com.davinci.toolbox.app.rules %{buildroot}/%{_datadir}/polkit-1/rules.d/com.davinci.toolbox.app.rules
...
%{python3_sitelib}/davinci_toolbox*
%{_datadir}/davinci-toolbox/*

# ELENCO DEI FILE INSTALLATI E DELLE LORO POSIZIONI
# LIST OF THE INSTALLED FILES AND THEIR POSITION
%{_bindir}/%{name}
%{_datadir}/applications/com.davinci.toolbox.app.desktop
%{_datadir}/icons/hicolor/scalable/apps/davinci-toolbox-icon.svg
%{_datadir}/metainfo/com.davinci.toolbox.app.metainfo.xml
%{_datadir}/polkit-1/actions/com.davinci.toolbox.app.policy
%{_datadir}/polkit-1/rules.d/com.davinci.toolbox.app.rules
