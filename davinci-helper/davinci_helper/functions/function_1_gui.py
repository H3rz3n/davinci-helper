...
class build_function_1 ():
    ...
    def install_dependencies (self) :
        ...
        function_1_log = subprocess.Popen("pkexec python /usr/lib/python*/site-packages/davinci_helper/functions/function_1.py",shell=True,  stdout=subprocess.PIPE, stderr=subprocess.STDOUT, text=True)
