...
class function_3_class (Gtk.ScrolledWindow):
    
    #-----------------------------------------------------------------------------------------------------

    # DEFINING TEMPLATE NAME
    __gtype_name__ = "Function3"
    ...
    def __init__(self, main_window):
        ...
        # LOADING ICON FILE
        self.section_1_icon.set_from_file(f"{icon_path}/main_icons/function_3.svg")

        # LOADING TITLE TEXT
        self.section_1_title.set_text(_("Apply the DaVinci Resolve\npost installation fix"))

        # LOADING INFO TEXT
        self.section_1_info.set_text(_("This part of the software will put some of the dependencies shipped with DaVinci Resolve in a safe folder, in order to make it use the system ones."))
    ...
    def reset_ui (self):
        ...
        self.main_self.function_3_content_revealer.set_reveal_child(False)
    ...
    def show_success (self, function_script):
        ...
        # LOADING TITLE TEXT
        self.section_3_title.set_text(_("The post installation fix\nhas been correctly applied"))

        # LOADING THE SUBTITLE TEXT
        self.section_3_subtitle.set_text(_("All the problematic libraries have been correctly moved inside the secure folder.\nNow you can correctly run DaVinci Resolve."))
    ...
    def show_error (self, function_script):
        ...
        # LOADING TITLE TEXT
        self.section_3_title.set_text(_("There was an error applying the fixes"))
        ...
        if function_script.returncode == 1 :
            ...
            # LOADING THE SUBTITLE TEXT
            self.section_3_subtitle.set_text(_("There was an error finding the DaVinci Resolve installation folder.\nPlease check the logs to have more details."))
        ...
        # CHECKING ERROR CODE 2
            ...
            # LOADING THE SUBTITLE TEXT
            self.section_3_subtitle.set_text(_("There was an error finding a compatible version of DaVinci Resolve on your system.\nPlease check the logs to have more details."))
        ...
        # CHECKING ERROR CODE 3
            ...
            # LOADING THE SUBTITLE TEXT
            self.section_3_subtitle.set_text(_("There was an error during the creation of the libraries' secure folder.\nPlease check the logs to have more details."))
        ...
        # CHECKING ERROR CODE 4
            ...
            # LOADING THE SUBTITLE TEXT
            self.section_3_subtitle.set_text(_("There was an error moving the libraries inside the secure folder.\nPlease check the logs to have more details."))
